...
function ContactForm() {
    ...
    function sendEmail(e) {
        ...
        emailjs.sendForm('hotmail', 'template_7pi3req', '#contactForm', 'user_2ClFT2CBVbPN3tPCiXsd0')
            .then(function (response) {
                console.log(response.text);
                setFormMessage("Message sent!");
            }, function (error) {
                console.log(error.text);
                setFormMessage("Failed to send message. Email directly at jautus@hotmail.com");
            });
    }
